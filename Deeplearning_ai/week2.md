...
- Loss function을 정의할 때, `<img src="https://latex.codecogs.com/svg.latex?\Large&space;\frac { 1 }{ 2 } { (\hat { y } -y) }^{ 2 }\quad" title="Loss function" />` 으로 한다면 경사하강법 실행 시 local minimun에 빠지기 쉽다.
